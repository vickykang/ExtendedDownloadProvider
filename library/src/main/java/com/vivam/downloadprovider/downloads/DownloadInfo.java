...
class DownloadInfo {
    public static class Reader {
        ...
        public DownloadInfo newDownloadInfo(Context context, SystemFacade systemFacade,
                                            ...
                                            DownloadNotifier notifer) {
            final DownloadInfo info = new DownloadInfo(
                    context, systemFacade, storageManager, notifer);
    ...
    private boolean isRoamingAllowed() {
        if (mIsPublicApi) {
            ...
            return mDestination != Downloads.DESTINATION_CACHE_PARTITION_NOROAMING;
        }
    }
    ...
    /*void startIfReady(long now) {
        ...
        DownloadThreadOld downloader = new DownloadThreadOld(mContext, mSystemFacade, this);
    ...
    public static int queryDownloadStatus(ContentResolver resolver, long id) {
        final Cursor cursor = resolver.query(
                ...
                new String[] { Downloads.COLUMN_STATUS }, null, null, null);
        try {
