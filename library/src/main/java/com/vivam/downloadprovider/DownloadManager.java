...
public class DownloadManager {
     ...
     */
    public final static String COLUMN_TITLE = Downloads.COLUMN_TITLE;
     ...
     */
    public final static String COLUMN_DESCRIPTION = Downloads.COLUMN_DESCRIPTION;

    /**
     * URI to be downloaded.
     */
    public final static String COLUMN_URI = Downloads.COLUMN_URI;
     ...
     */
    public final static String COLUMN_STATUS = Downloads.COLUMN_STATUS;
    ...
    public static final String[] UNDERLYING_COLUMNS = new String[]{
            ...
            Downloads.COLUMN_TOTAL_BYTES + " AS " + COLUMN_TOTAL_SIZE_BYTES,
            Downloads.COLUMN_LAST_MODIFICATION + " AS " + COLUMN_LAST_MODIFIED_TIMESTAMP,
            Downloads.COLUMN_CURRENT_BYTES + " AS " + COLUMN_BYTES_DOWNLOADED_SO_FAR,
    ...
    public static class Request {
         ...
         * {@link android.app.NotificationManager}. By default,
         * a notification is shown.
         * <p/>
         * If set to false, this requires the permission
         * android.permission.DOWNLOAD_WITHOUT_NOTIFICATION.
         *
         * @param show whether the download manager should show a notification
         *             for this download.
         * @return this object
         */
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (STATUS_SUCCESSFUL == status) {
                    int index = cursor.getColumnIndexOrThrow(Downloads.COLUMN_DESTINATION);
                    int destination = cursor.getInt(index);
                    // return public uri
     ...
     * otherwise.
     */
    public String getMimeTypeForDownloadFile(long id) {
        Query query = new Query().setFilterById(id);
        Cursor cursor = null;
        try {
            cursor = query(query);
        ...
        try {
            for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor
                ...
                if (status != STATUS_PAUSED) {
                    throw new IllegalArgumentException(
                            "Can only resume a paused download: "
                                    + cursor.getLong(cursor
                                    .getColumnIndex(COLUMN_ID)));
                }
            }
    ...
    private static class CursorTranslator extends CursorWrapper {
        ...
        public long getLong(int columnIndex) {
            if (getColumnName(columnIndex).equals(COLUMN_REASON)) {
                return getReason(super.getInt(getColumnIndex(Downloads.COLUMN_STATUS)));
            } else if (getColumnName(columnIndex).equals(COLUMN_STATUS)) {
                return translateStatus(super.getInt(getColumnIndex(Downloads.COLUMN_STATUS)));
            } else {
